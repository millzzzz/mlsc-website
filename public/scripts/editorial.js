...
// src/components/editorial/EditorialClient.tsx
var import_react3 = __toESM(require_react(), 1);
var import_client = __toESM(require_client(), 1);

// src/components/editorial/EditorialPage.tsx
var import_react2 = __toESM(require_react(), 1);

// src/components/editorial/MasonryGrid.tsx
var import_react = __toESM(require_react(), 1);
var MasonryGrid = ({ items, selectedCategory }) => {
  const [filteredItems, setFilteredItems] = import_react.useState([]);
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", {
    ...
    const displayImage = item.galleryImages && item.galleryImages.length > 0 ? item.galleryImages[0].image : item.featuredImage;
    const aspectRatio = item.galleryImages && item.galleryImages.length > 0 ? item.galleryImages[0].aspectRatio : "square";
    return /* @__PURE__ */ import_react.default.createElement("div", {
      key: item.id,
...
var MasonryGrid_default = MasonryGrid;

// src/components/editorial/EditorialPage.tsx
var EditorialPage = ({ posts, isPreviewMode = false }) => {
  const [selectedCategory, setSelectedCategory] = import_react2.useState("all");
  const [categories, setCategories] = import_react2.useState([]);
  ...
  return /* @__PURE__ */ import_react2.default.createElement("div", {
    className: `editorial-page ${isPreviewMode ? "preview-mode" : ""}`
  }, /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "editorial-header"
  }, /* @__PURE__ */ import_react2.default.createElement("h1", null, "Editorial")), /* @__PURE__ */ import_react2.default.createElement("nav", {
    ...
    href: "/sketchbooks",
    className: "nav-link"
  }, "SKETCHBOOKS"), /* @__PURE__ */ import_react2.default.createElement("a", {
    href: "/paintings",
    className: "nav-link"
  }, "PAINTINGS"), /* @__PURE__ */ import_react2.default.createElement("a", {
    href: "/editorial",
    className: "nav-link active"
  }, "EDITORIAL"), /* @__PURE__ */ import_react2.default.createElement("a", {
    href: "/shop",
    className: "nav-link"
  }, "SHOP"), /* @__PURE__ */ import_react2.default.createElement("a", {
    href: "/pdf",
    className: "nav-link"
  }, "PDF")), /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "categories"
  }, /* @__PURE__ */ import_react2.default.createElement("button", {
    className: `category-button ${selectedCategory === "all" ? "active" : ""}`,
    onClick: () => handleCategorySelect("all")
  }, "All"), categories.map((category) => /* @__PURE__ */ import_react2.default.createElement("button", {
    key: category,
    className: `category-button ${selectedCategory === category ? "active" : ""}`,
    onClick: () => handleCategorySelect(category)
  }, formatCategoryName(category)))), posts && posts.length > 0 ? /* @__PURE__ */ import_react2.default.createElement(MasonryGrid_default, {
    items: posts,
    selectedCategory
  }) : /* @__PURE__ */ import_react2.default.createElement("div", {
    className: "no-editorials"
  }, /* @__PURE__ */ import_react2.default.createElement("p", null, "No editorial content found.")), /* @__PURE__ */ import_react2.default.createElement("footer", {
    className: "editorial-footer"
  }, /* @__PURE__ */ import_react2.default.createElement("p", null, "© 2025 MLSC Studio. All rights reserved.")));
};
var EditorialPage_default = EditorialPage;

// src/components/editorial/EditorialClient.tsx
function hydrateEditorialPage(elementId, posts, isPreviewMode = false) {
  ...
  try {
    ...
    root.render(/* @__PURE__ */ import_react3.default.createElement(EditorialPage_default, {
      posts,
      isPreviewMode
    }));
...
function fallbackRender(container, posts) {
  ...
  posts.forEach((post) => {
    const displayImage = post.galleryImages && post.galleryImages.length > 0 ? post.galleryImages[0].image : post.featuredImage;
    const aspectRatio = post.galleryImages && post.galleryImages.length > 0 ? post.galleryImages[0].aspectRatio : "square";
    html += `
...
window.renderEditorialPage = (posts, isPreviewMode = false) => {
